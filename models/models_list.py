...
class FaceDetection(nn.Module):
    def __init__(self):
        ...
        self.facenet.load_state_dict(torch.load("models/savedir/facenet_01_it5k.pth"))
        self.size = 74
